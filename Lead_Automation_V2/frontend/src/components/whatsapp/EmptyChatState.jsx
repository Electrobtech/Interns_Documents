...
export default function EmptyChatState({ onCompose }) {
        ...
        <div className="fixed inset-0 bg-black/30 z-50 grid place-items-center px-4" onClick={() => setShowModal(false)}>
          ...
          >
            ...
            <p className="text-sm text-slate-500">
              New WhatsApp conversations are created automatically the moment a contact messages your connected
              number — there isn&apos;t a way to start one from here yet. Once they write in, it&apos;ll show up in this list.
            </p>
            <button
              type="button"
