/**
 * Sample data ported verbatim from the reference build.
 *
 * NOTHING HERE IS MEASURED. These are the reference's illustrative figures,
 * kept so the hub can be reviewed and demoed at full fidelity before the
 * live endpoints are wired back in. Every screen that reads from this file
 * renders a `Sample data` marker.
 */
export const campaigns = [
  { id: '1', name: 'AI Bootcamp Lead Gen Q3', platform: 'Facebook', objective: 'Lead Generation', status: 'Active', budget: 5000, spend: 3240, ctr: 4.2, cpm: 8.4, cpc: 2.1, reach: 142000, impressions: 385000, leads: 1540, conversions: 312, revenue: 93600, roas: 28.9, createdBy: 'Priya Sharma', createdDate: '2025-06-01', updatedDate: '2025-07-28', aiScore: 94 },
  { id: '2', name: 'SaaS Growth Campaign', platform: 'LinkedIn', objective: 'Website Traffic', status: 'Active', budget: 8000, spend: 6120, ctr: 3.1, cpm: 12.6, cpc: 4.1, reach: 89000, impressions: 486000, leads: 890, conversions: 198, revenue: 59400, roas: 9.7, createdBy: 'Rahul Verma', createdDate: '2025-05-15', updatedDate: '2025-07-30', aiScore: 81 },
  { id: '3', name: 'Webinar Registration Drive', platform: 'Google Ads', objective: 'Event Registration', status: 'Scheduled', budget: 3000, spend: 0, ctr: 0, cpm: 0, cpc: 0, reach: 0, impressions: 0, leads: 0, conversions: 0, revenue: 0, roas: 0, createdBy: 'Ananya Iyer', createdDate: '2025-07-10', updatedDate: '2025-07-10', aiScore: 72 },
  { id: '4', name: 'Brand Awareness Wave', platform: 'Instagram', objective: 'Brand Awareness', status: 'Paused', budget: 4500, spend: 2100, ctr: 1.8, cpm: 6.2, cpc: 3.4, reach: 320000, impressions: 338000, leads: 0, conversions: 45, revenue: 0, roas: 0, createdBy: 'Vikram Singh', createdDate: '2025-04-20', updatedDate: '2025-06-30', aiScore: 56 },
  { id: '5', name: 'WhatsApp Retargeting', platform: 'WhatsApp', objective: 'Remarketing', status: 'Active', budget: 1200, spend: 940, ctr: 6.7, cpm: 4.1, cpc: 0.6, reach: 22000, impressions: 229000, leads: 1100, conversions: 540, revenue: 162000, roas: 172.3, createdBy: 'Priya Sharma', createdDate: '2025-07-01', updatedDate: '2025-07-31', aiScore: 97 },
  { id: '6', name: 'Enterprise Sales Push', platform: 'Email', objective: 'Sales', status: 'Draft', budget: 500, spend: 0, ctr: 0, cpm: 0, cpc: 0, reach: 0, impressions: 0, leads: 0, conversions: 0, revenue: 0, roas: 0, createdBy: 'Ananya Iyer', createdDate: '2025-07-25', updatedDate: '2025-07-25', aiScore: 68 },
  { id: '7', name: 'Course Enrollment - Python', platform: 'Facebook', objective: 'Course Registration', status: 'Active', budget: 2500, spend: 2100, ctr: 5.4, cpm: 7.8, cpc: 1.4, reach: 68000, impressions: 269000, leads: 1870, conversions: 420, revenue: 126000, roas: 60.0, createdBy: 'Rahul Verma', createdDate: '2025-06-15', updatedDate: '2025-07-29', aiScore: 91 },
  { id: '8', name: 'Google Search - B2B', platform: 'Google Ads', objective: 'Lead Generation', status: 'Active', budget: 6000, spend: 5400, ctr: 8.2, cpm: 22.1, cpc: 2.7, reach: 45000, impressions: 244000, leads: 2000, conversions: 650, revenue: 195000, roas: 36.1, createdBy: 'Vikram Singh', createdDate: '2025-05-01', updatedDate: '2025-07-31', aiScore: 88 },
];
...
export const kpiData = {
  totalCampaigns: 48,
  runningCampaigns: 14,
  scheduledCampaigns: 6,
  draftCampaigns: 9,
  leadsGenerated: 28420,
  conversionRate: 18.4,
  ctr: 4.8,
  cpc: 2.3,
  cpm: 8.9,
...
export const aiInsights = [
  ...
  { id: '3', type: 'info', title: 'Optimal Launch Window Detected', campaign: 'Webinar Registration Drive', current: 'Scheduled', expected: 'Tuesday 9–11 AM', recommendation: 'Shift launch to Tuesday 9 AM IST for 23% higher open rate based on audience data.', confidence: 84 },
  ...
  { id: '5', type: 'info', title: 'Competitor Keyword Gap Found', campaign: 'SEO', current: '42 gaps', expected: 'Covered', recommendation: "Your competitors rank for 42 high-volume keywords you don't target. Top 5: 'AI marketing tools', 'lead automation', 'WhatsApp CRM'.", confidence: 79 },
];
...
export const knowledgeDocs = [
  ...
  { id: '3', title: 'AI Bootcamp Case Study', category: 'Case Studies', tags: ['case study', 'lead gen', 'results'], updatedAt: '2025-06-28', size: '800 KB' },
