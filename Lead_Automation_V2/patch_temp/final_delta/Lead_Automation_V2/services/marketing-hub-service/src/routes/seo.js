...
// Get all keywords
router.get('/keywords', authenticate, requirePermission('campaigns:read'), async (req, res) => {
  try {
...
router.post('/keywords', authenticate, requirePermission('campaigns:write'), async (req, res) => {
  try {
    ...
    const result = await query(
      ...
      [
        req.user.organizationId, keyword, keywordData.search_volume, keywordData.difficulty,
...
// Get keyword by ID
router.get('/keywords/:id', authenticate, requirePermission('campaigns:read'), async (req, res) => {
  try {
    const result = await query(
...
// Update keyword
router.put('/keywords/:id', authenticate, requirePermission('campaigns:write'), async (req, res) => {
  try {
    ...
    const result = await query(
      `UPDATE mh_seo_keywords 
       ...
       RETURNING *`,
      [current_rank, target_rank, url, req.params.id, req.user.organizationId]
    );
...
// Delete keyword
router.delete('/keywords/:id', authenticate, requirePermission('campaigns:write'), async (req, res) => {
  try {
    const result = await query(
...
// Get SEO audits
router.get('/audits', authenticate, requirePermission('campaigns:read'), async (req, res) => {
  try {
...
// Create SEO audit
router.post('/audits', authenticate, requirePermission('campaigns:write'), async (req, res) => {
  try {
    ...
    const result = await query(
      ...
      [
        req.user.organizationId, url, audit_type, auditResults.score,
...
router.post('/keywords/suggestions', authenticate, requirePermission('campaigns:read'), async (req, res) => {
  try {
...
// Get SEO insights
router.get('/insights', authenticate, requirePermission('campaigns:read'), async (req, res) => {
  try {
...
// Keyword research
router.post('/research', authenticate, requirePermission('campaigns:read'), async (req, res) => {
  try {
