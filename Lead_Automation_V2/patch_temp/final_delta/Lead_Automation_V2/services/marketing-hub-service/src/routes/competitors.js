...
router.post('/', authenticate, requirePermission('campaigns:write'), async (req, res) => {
  try {
    ...
    const result = await query(
      ...
      [
        req.user.organizationId, name, domain, industry, channels || [],
...
router.get('/:id/analysis', authenticate, requirePermission('campaigns:read'), async (req, res) => {
  try {
...
router.post('/:id/analysis', authenticate, requirePermission('campaigns:write'), async (req, res) => {
  try {
...
router.get('/overview/dashboard', authenticate, requirePermission('campaigns:read'), async (req, res) => {
  try {
