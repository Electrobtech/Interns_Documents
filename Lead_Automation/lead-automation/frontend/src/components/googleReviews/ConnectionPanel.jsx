...
export default function ConnectionPanel({
  status, statusLoading, accounts, locations, busy,
    ...
    return (
      <div className="bg-white border border-slate-200 rounded-xl p-5 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">Sync your Google reviews and reply to customers right from this dashboard.</p>
        </div>
        <button onClick={onConnect} disabled={busy}
          className="flex items-center gap-1.5 bg-brand text-white text-sm rounded-lg px-4 py-2 font-medium disabled:opacity-60">
