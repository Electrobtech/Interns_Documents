      ...
      <div className="relative bg-white rounded-2xl shadow-card-lg w-full max-w-lg animate-scale-in border border-slate-200 max-h-[90vh] overflow-y-auto">
        ...
        {done ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm font-semibold text-slate-700">Campaign created as a draft</p>
            <p className="text-xs text-slate-400 mt-1">Find it in Campaigns & Broadcasts to schedule or send it.</p>
            <div className="flex gap-2 justify-center mt-5">
              <a href="/campaigns" className="btn-primary btn-sm">
          ...
          <form onSubmit={submit} className="p-6 space-y-4">
            ...
            <div className="flex gap-2 pt-1">
              <button type="submit" disabled={create.isPending || !name.trim() || !messageBody.trim()} className="btn-primary flex-1">
                <Send size={14} />
                {create.isPending ? 'Saving…' : 'Save as Draft Campaign'}
              </button>
