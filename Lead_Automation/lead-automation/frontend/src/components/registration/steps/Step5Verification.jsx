  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-xs text-slate-400 mt-0.5">Confirm your contact details and (optionally) your business registration.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <TextField label="GST Number" placeholder="22AAAAA0000A1Z5" value={value.gstNumber || ''}
          error={errors.gstNumber} onChange={(e) => set({ gstNumber: e.target.value.toUpperCase() })} />
