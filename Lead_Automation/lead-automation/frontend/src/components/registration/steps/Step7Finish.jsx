...
export default function Step7Finish({ form, errors, onChange, onEdit }) {
  const { owner, company, contact, address, verification, subscription } = form;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <SummaryCard title="Account Owner" stepId={1} onEdit={onEdit}>
        ...
        <SummaryCard title="Company" stepId={2} onEdit={onEdit}>
        ...
        <SummaryCard title="Business Contact" stepId={3} onEdit={onEdit}>
          <SummaryRow label="Email" value={contact.companyEmail} />
          <SummaryRow label="Phone" value={contact.companyPhone} />
        </SummaryCard>

        <SummaryCard title="Address" stepId={4} onEdit={onEdit}>
        ...
        <SummaryCard title="Verification" stepId={5} onEdit={onEdit}>
          <SummaryRow label="GST" value={verification.gstNumber} />
          <SummaryRow label="PAN" value={verification.panNumber} />
          <SummaryRow label="Email verified" value={verification.emailVerified ? 'Yes' : 'No'} />
        </SummaryCard>

        <SummaryCard title="Subscription" stepId={6} onEdit={onEdit}>
