"""Groq — OpenAI-compatible chat completions API. Primary generation provider."""
...
class GroqProvider(LLMProvider):
    ...
    async def agenerate(
        ...
        *,
        ...
        # Attach usage metadata so the instrumented wrapper can log it.
    ...
    async def embed(self, texts: list[str]) -> list[list[float]]:
        raise NotImplementedError(
            "Groq has no embeddings API — embeddings always route through Ollama."
        )
